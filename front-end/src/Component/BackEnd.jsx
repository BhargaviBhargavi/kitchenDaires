...
const Backend = () => {
    ...
    const searchrecipedata = () =>{
        fetch(`http://localhost:5500/search/${recipeData}`).then((res)=>{
            return res.json();
        }).then((res)=>{
            setrecipeData(res);
            console.log(res);
    ...
    return (<div>
                    ...
                    <div className="nav">
                        <nav className="navbar">
                            <div className="firstContainer">
                                ...
                                <img src="Resources/searchbar1.png" alt="" className="search" onClick={searchrecipedata}/>
        ...
        <h4 className="clear" onClick={fetchData}>Clear Search</h4>
